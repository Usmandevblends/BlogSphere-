        ...
        <div className="container mx-auto">
          <div className="grid">
            <div className='blogimg flex flex-col items-center justify-center col-span-12'>
              ...
              <h2 className="text-3xl font-bold text-gray-900">The Future of AI</h2>
              <p className='mx-auto blogpra'>AI is still developing, and its potential seems endless. Experts believe that in the future, we will see progress in general AI, where machines will be able to think and solve problems just like humans. Another exciting area is emotional intelligence in robots, where machines will be able to understand and respond to human emotions, making them more helpful in areas like healthcare and customer service.
